#!/homepages/45/d895236634/htdocs/python_files/venv/bin/python

import os
import sys
import traceback

home = '/homepages/45/d895236634/htdocs/'
try:
    os.environ['VIRTUAL_ENV'] = os.path.join(home, 'python_files/venv/bin')
    os.environ['PATH'] = os.environ['VIRTUAL_ENV'] + ':' + os.environ['PATH']

    project = os.path.join(home, 'MattyA')
    ...
    os.environ['DJANGO_SETTINGS_MODULE'] = "MattyA.settings"
